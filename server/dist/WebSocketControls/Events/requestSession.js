...
exports.requestSessionEventCallback = void 0;
const requestSessionEventCallback = ({ sessionId }, { client, clients, activeSessions }) => {
    var _a;
...
exports.requestSessionEventCallback = requestSessionEventCallback;
